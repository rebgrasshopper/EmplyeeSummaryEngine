...
const render = employees => {
  ...
  //identify the team for this render
  team = employees[0].team;

  //make Manager, Engineer, and Intern objects out of employee data
  ...
  //set up arrays to hold html for each employee
  const managerhtml = [];
  const engineerhtml = [];
  const internhtml = [];
  
  //turn each employee into html, and push to array
  ...
  //send alert if no manager present in team
  ...
  //return a page rendered with the three lists of employee html
